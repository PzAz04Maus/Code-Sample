...
Methods
	...
	void printForwards();
		cout the nodes in sequence, forwards
	void printBackwards();
		cout the nodes in sequence, backwards
...
List<T>& List<T>::operator=(const List<T>& rhs)
{
	...
	{
		throw Exception("selfreference or empty source!");
	}
	return *this;
}
...
const T& List<T>::First()
{
	...
	{
		throw Exception("First not found!");
	}
	return answer;
}
...
const T& List<T>::Last()
{
	...
	{
		throw Exception("Last not found!");
	}
	return answer;
...
inline iter_ll<T>& iter_ll<T>::operator=(const iter_ll<T>&& move)
{
	...
	{
		throw Exception("Illegal moving of self!");
	}
	return *this;
}
